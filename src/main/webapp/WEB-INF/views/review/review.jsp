    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-md-7 py-4">
          ...
          <p class="text-muted">리뷰 게시판 작성시 말 머리에 [지점명]을 달고 작성 해 주시기 바랍니다!</p>
        </div>
				...
				<div id="content">
					...
					<c:forEach var="r" items="${reviews}">
						<table border="1" width="400px" height="150px">
							<tr>
								<td style="font-family: 'BMJUA';">${r.r_num}&nbsp;</td>
								<td style="font-family: 'BMJUA';"><fmt:formatDate value="${r.r_date}" dateStyle="short" /></td>
								<td style="font-family: 'BMJUA';">${r.r_id}&nbsp;</td>
								<td style="font-family: 'BMJUA';">${r.r_content}&nbsp;</td>
								<td><img src="resources/reviewimg/${r.r_picture}" width = "100px", height = "100px">&nbsp;</td>
							</tr>
						</table>
					</c:forEach>
				</div>
